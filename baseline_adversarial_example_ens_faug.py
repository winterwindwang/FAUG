...
from models.model_utils import get_model_by_name, get_aug_model_by_name, get_attack_by_name, create_save_path, obj, ConfigParser
...
def test(model, atk, data_loader, save_dir, **atk_config):
    total = 0
    fr_num = 0
    acc_num = 0
    acc_clean_num = 0
...
def get_args():
    ...
    parser.add_argument("--save-path", type=str, default='./saved_images/Compared_method_ENS_FAUG')
    ...
    parser.add_argument('--attack', default='cwa', type=str, help='the attack algorithm', choices=transferattack.attack_zoo.keys())
    ...
    parser.add_argument('--model', default='swin_s3_base_224,vit_base_patch16_224,pit_b_224,visformer_small', type=str, help='the source surrogate model')
    ...
    parser.add_argument("--std1", type=float, default=0.3)
    parser.add_argument("--cfg", type=str, default='swin_s3_base_224.yaml,vit_base_patch16_224.yaml,pit_b_224.yaml,visformer_small.yaml',
...
ems_feature_layers = {
    "resnet50": "conv",
    "resnext50_32x4d": "conv",
    "vgg19_bn": "features_0",
    "densenet121": "feature_0",
    "visformer_small": "stage3_0",
    "pit_b_224": "block_1_0",
    "vit_base_patch16_224": "blocks_5",
    "swin_s3_base_224": "layers_0",
...
if __name__ == "__main__":
    ...
    nohup python -u baseline_adversarial_example_ens_faug.py --model "resnet50,vgg19_bn,resnext50_32x4d,densenet121" --cfg "resnet50.yaml,vgg19_bn.yaml,resnext50_32x4d.yaml,densenet121.yaml" > spawn_baseline_cwa_faug_cnn_ensemble_20240511.out 2>& 1&

    nohup python -u baseline_adversarial_example_ens_faug.py --model "resnet50,vgg19_bn,pit_b_224,visformer_small" --cfg "resnet50.yaml,vgg19_bn.yaml,pit_b_224.yaml,visformer_small.yaml" > spawn_baseline_cwa_faug_hybired_ensemble_20240511.out 2>& 1&

    nohup python -u baseline_adversarial_example_ens_faug.py --model "swin_s3_base_224,vit_base_patch16_224,pit_b_224,visformer_small" --cfg "swin_s3_base_224.yaml,vit_base_patch16_224.yaml,pit_b_224.yaml,visformer_small.yaml" > spawn_baseline_cwa_faug_transformer_ensemble_20240511.out 2>& 1&
    ...
    atk_config['std1'] = args.std1
    model_list = []
    atk_config['model_names'] = args.model.split(",")
    for mname in args.model.split(","):
        model = get_aug_model_by_name(mname, device=device)
        model_list.append(model)
        atk_config[mname] = ems_feature_layers[mname]
    ...
    # )
    attacker = transferattack.load_attack_class(args.attack)(model_name=EnsembleModel(model_list), **atk_config)
    ...
    acc_clean, acc_adv, fooling_rate, acc = test(model_ori, attacker, data_loader, save_dir, **atk_config)
